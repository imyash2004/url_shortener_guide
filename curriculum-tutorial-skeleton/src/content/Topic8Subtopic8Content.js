  ...
  return (
    <div className="topic-animated-content">
      ...
      <div className="yellow-callout">
        In this final section of the security module, we'll explore how to{" "}
        <strong>test protected endpoints, verify token validation</strong>, and
      ...
      <div className="blue-card-section">
        <p>
          Even if your code looks solid, there could be gaps. Security testing
          ensures:
        </p>
        <ul style={{ margin: "0.7rem 0 0 1.2rem" }}>
          <li>
            🔐 Protected endpoints{" "}
            <strong>aren't accessible without a valid JWT</strong>
          </li>
          <li>
            🚫 Invalid tokens are{" "}
            <strong>rejected with proper error codes</strong>
          </li>
          <li>
            👤 Role-based access <strong>actually works</strong>
          </li>
          <li>🧪 Automated tests catch bugs before users do</li>
        </ul>

        <p style={{ marginTop: "1rem" }}>
          Without it, your app might be vulnerable to unauthorized access, token
      ...
      <div className="blue-card-section">
        <p>
          You can use <strong>Postman</strong>, <strong>cURL</strong>, or write{" "}
          <strong>JUnit + Spring Security tests</strong>.
        </p>
        <p>
          For this section, we'll cover both <strong>manual</strong> (Postman)
          and <strong>automated</strong> (JUnit) testing.
        </p>
      </div>
      ...
      <div className="blue-card-section" style={{ marginBottom: "1rem" }}>
        ...
        >
          <button
            ...
            onClick={() =>
              copyToClipboard(codeBlocks.publicEndpoint, "publicEndpoint")
            }
          >
        ...
        <p>
          <strong>Expected:</strong> 200 OK, no token needed.
        </p>
      </div>
        ...
        >
          <button
            className={`copy-button ${
              copied.protectedEndpoint ? "copied" : ""
            }`}
            onClick={() =>
              copyToClipboard(codeBlocks.protectedEndpoint, "protectedEndpoint")
            }
          >
      ...
      <div className="blue-card-section" style={{ marginBottom: "1rem" }}>
        ...
        >
          <button
            ...
            onClick={() =>
              copyToClipboard(codeBlocks.invalidToken, "invalidToken")
            }
          >
      ...
      <div className="blue-card-section">
        ...
        >
          <button
            ...
            onClick={() =>
              copyToClipboard(codeBlocks.roleBasedTest, "roleBasedTest")
            }
          >
        ...
        <ul style={{ margin: "0.7rem 0 0 1.2rem" }}>
          <li>
            If JWT has <code>ROLE_ADMIN</code>: ✅ 200 OK
          </li>
      ...
      <div
        style={{ marginTop: "2rem", textAlign: "center", fontSize: "1.5rem" }}
      >
